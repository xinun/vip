...
/// 메인 페이지 위젯
class WaitPage2 extends StatefulWidget {
  const WaitPage2({super.key});

  @override
  State<WaitPage2> createState() => _WaitPageState();
}

/// WaitPage의 상태 관리 클래스
class _WaitPageState extends State<WaitPage2> with TickerProviderStateMixin {
