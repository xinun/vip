...
class Level2Page extends StatefulWidget {
  ...
  @override
  State<Level2Page> createState() => _Level1PageState();
}

class _Level1PageState extends State<Level2Page> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      body: Center(
        child: AnimatedBuilder(
          ...
          child: Image.asset(
            'assets/lv2_t.png', // 이미지 경로 (텍스트 이미지를 넣으세요)
            width: 200, // 이미지 너비
          ),
        ),
      ),
