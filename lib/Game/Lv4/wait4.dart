...
/// 메인 페이지 위젯
class WaitPage4 extends StatefulWidget {
  const WaitPage4({super.key});

  @override
  State<WaitPage4> createState() => _WaitPageState();
}

/// WaitPage의 상태 관리 클래스
class _WaitPageState extends State<WaitPage4> with TickerProviderStateMixin {
